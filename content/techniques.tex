...
Furthermore, in local analysis, four levels of analysis aggressivness were
...
for infinite loops. A speciall, level, enabled by a different flag for {\tt
cov-analysis}, then enables almost all checkers, with only few minor
exceptions. For full (rather long) list of what checkers are enabled on every

...
\projectinfo{
  ...
  abstract.en={
	...
	is then a subject to static analysis and the used tools (CppCheck,
	Coverity, Codacy, GCC, Clang) are compared in terms of the number
	and type of the found defects.
  }, 
  %Prohlaseni
  declaration={
...
Coverity, Codacy, GCC, Clang, CppCheck.}
